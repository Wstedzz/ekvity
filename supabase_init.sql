...
-- 2. Drop & recreate tables (ensures correct column casing)
DROP TABLE IF EXISTS public.products CASCADE;
DROP TABLE IF EXISTS public.categories CASCADE;
DROP TABLE IF EXISTS public.constructor_flowers CASCADE;
...
CREATE TABLE public.constructor_flowers (
    id text PRIMARY KEY,
    name text NOT NULL,
    price numeric NOT NULL DEFAULT 0,
    image text
...
DROP POLICY IF EXISTS "Public Read Constructor Flowers" ON public.constructor_flowers;
...
DROP POLICY IF EXISTS "Admin Insert Constructor Flowers" ON public.constructor_flowers;
DROP POLICY IF EXISTS "Admin Update Constructor Flowers" ON public.constructor_flowers;
DROP POLICY IF EXISTS "Admin Delete Constructor Flowers" ON public.constructor_flowers;
...
-- Constructor Flowers (5 flowers from the bouquet constructor)
...
-- Site settings (all 11 keys used by the frontend)
